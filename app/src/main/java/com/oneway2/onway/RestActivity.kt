...
class RestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mWebSettings: WebSettings = webview3.getSettings()
        mWebSettings.javaScriptEnabled = true
        mWebSettings.setSupportZoom(false)
        mWebSettings.allowFileAccess = true
        mWebSettings.allowContentAccess = true

        webview3.setWebChromeClient(object : WebChromeClient() {
        ...
        navigation_view4.setNavigationItemSelectedListener{
            when (it.itemId) {
                R.id.nav_home -> {
        ...
        drawer_layout4.addDrawerListener(drawerToggle)
    ...
    override fun onBackPressed() {
        if (drawer_layout4.isDrawerOpen(GravityCompat.START)) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawer_layout4.openDrawer(GravityCompat.START)
                true
            }
    ...
    fun loadURL() {
        webview3.loadUrl("http://onway.ps/Resturants_signup")
        webview3.settings.javaScriptEnabled = true
        webview3.settings.loadsImagesAutomatically = true
